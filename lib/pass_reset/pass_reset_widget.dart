            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 120, 150, 8),
                    child: Row(
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '5gmhe6wi' /* We will send you an email with... */,
                      ),
